...
class OrmGenerator
{
	...
	public function generate(db:Db, autogeneratedPackage:String, customPackage:String, ignoreTables:TypedArray<String>, noInstantiateManagers:TypedArray<String>, positions:OrmPositions)
	{
		var autogenOrmClassName = autogeneratedPackage + ".Orm";
		...
		Syntax.foreach(db.connection.getTables(), function(_, tableName:String)
        {
			...
			{
				var table = new OrmTable(tableName, autogeneratedPackage, customPackage);
