...
class Main 
{
	static function main()
	{
		...
		options.add("autogeneratedPackage", "models\\autogenerated", Syntax.arrayDecl("-a", "--autogenerated-package"),
			...
			//{
				...
				if (databaseConnectionString != "")
				{
					...
					(
						...
						(cast options.get("autogeneratedPackage") : String).ltrim("\\").replace("\\", "."),
						(cast options.get("customPackage") : String).ltrim("\\").replace("\\", "."),
