		...
		if (args.length > 0)
		{
			...
			//{
				...
				if (databaseConnectionString != "")
				{
					...
					new OrmGenerator(outPath).generate(new Db(databaseConnectionString), options.get("autogeneratedNamespace"), options.get("customNamespace"), options.get("ignoreTables"), options.get("noInstantiateManagers"), new OrmPositions(positions));
