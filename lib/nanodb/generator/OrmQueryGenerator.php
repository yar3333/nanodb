...
class OrmQueryGenerator {
	...
	public function getQueryClass ($table, $vars, $queryClassName, $customModelClassName, $customManagerClassName) {
		...
		$model->addMethod("findMany", [new GeneratorPhpVar("limit", "int", "null"), new GeneratorPhpVar("offset", "int", "null")], GeneratorTools::toPhpType($customModelClassName) . "[]", "return parent::findMany(\$limit, \$offset);");
