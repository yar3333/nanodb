...
class CmdOptions
{
    ...
    public function getHelpMessage($prefix = "\t")
    {
        ...
        foreach ($collection1 as $key1 => $value1) {
            ...
            if (($value1->help !== null) && ($value1->help !== '')) {
                ...
                $s .= (implode('', array_map(static function ($s3) use (&$maxSwitchLength, &$prefix) {
    ...
    {
        return current(array_filter($this->options, static function ($opt) use (&$name) {
