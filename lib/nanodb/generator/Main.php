	...
	static public function main () {
		...
		if (count($args) > 0) {
			...
			if ($databaseConnectionString !== "") {
				...
				(new GeneratorOrmGenerator($outPath))->generate(new Db($databaseConnectionString), str_replace("\\", ".", ltrim($options->get("autogeneratedNamespace"), "\\")), str_replace("\\", ".", ltrim($options->get("customNamespace"), "\\")), $options->get("ignoreTables"), $options->get("noInstantiateManagers"), new GeneratorOrmPositions($positions));
