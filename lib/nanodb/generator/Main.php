...
class Main {
	...
	static public function main () {
		...
		$options->add("autogeneratedNamespace", "models.autogenerated", ["-a", "--autogenerated-namespace"], "Package name for autogenerated classes.\x0A" . "Default is 'models.autogenerated'.");
		$options->add("customNamespace", "models", ["-c", "--custom-namespace"], "Package name for your custom classes.\x0A" . "Default is 'models'.");
